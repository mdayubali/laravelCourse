<x-guest-layout>
    <h2 class="text-center text-2xl font-semibold py-5">Test</h2>
              ...
              <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                ...
                <ul class="flex flex-wrap items-center gap-4 mt-5 text-gray-700">
                  ...
                  <li class="flex items-center gap-2">
                    ...
                    <span>{{ $course->level($course->difficulty_level) }}</span>
                  </li>
                  <li class="flex items-center gap-2">
                ...
                <div class="rounded-sm mt-8 shadow-sm bg-white">
                  <img class="w-full h-auto" src="{{ $course->image }}" alt="{{ $course->name }}">
                  <div class="p-6">
                ...
                @if (count($course->reviews))
                        @foreach ( $course->reviews as $review)
                            <div class="mb-6 bg-white p-4">
                                ...
                                <h3 class="font-bold text-xl">{{ $review->user->name }}</h3>
                            </div>
                        @endforeach
                      @else
                  ...
                  <div class="space-y-4 p-6">
                    ...
                    <div class="space-y-4 pb-2">
                      ...
                      <ul role="list" class="flex space-x-5 justify-center">
                        ...
                        <li>
                            <a href="{{ $author->website }}" class="text-gray-400 hover:text-gray-500" target="_blank">
