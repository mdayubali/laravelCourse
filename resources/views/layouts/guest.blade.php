                ...
                <div class="flex h-16 justify-between items-center">
                    ...
                    <div class="flex items-center">
                        @if(Auth::check())
                          ...
                          @if (Auth::user()->type===1) <a href="{{ route('dashboard') }}" class="bg-black px-4 py-2 text-white rounded border shadow-sm hover:bg-red-500 ml-3">
                            Dashboard
                        </a>
                        @else
                        <a href="#" class="bg-black px-4 py-2 text-white rounded border shadow-sm hover:bg-red-500 ml-3">
                           Submit Course
                        </a>
                        @endif
                        <form class="ml-4" action="{{ route('logout') }}" method="post">
                            @csrf
                            <button class="text-red-400" type="submit">Log out</button>
                        </form>
                        @else
        ...
        <div class="container flex justify-between pb-[50px]">
          <div>
            ...
            <ul class="mt-5">
              ...
              <li class="mb-2">
                <a href="{{ route('archive',['series','Javascripts']) }}" class="text-links text-gray-100 text-base before:text-gray-100">Javascripts</a>
              </li>
              <li class="mb-2">
          ...
          <div>
            ...
            <ul class="mt-5">
              <li class="mb-2">
                <a href="{{ route('archive',['duration','1-5hours']) }}" class="text-links text-gray-100 text-base before:text-gray-100">1-5 hours</a>
              </li>
              <li class="mb-2">
                <a href="{{ route('archive',['duration','5-10hours']) }}" class="text-links text-gray-100 text-base before:text-gray-100">5-10 hours</a>
              </li>
              <li class="mb-2">
          ...
          <div>
            ...
            <ul class="mt-5">
              ...
              <li class="mb-2">
                <a href="{{ route('archive',['duration','codecourse']) }}" class="text-links text-gray-100 text-base before:text-gray-100">Codecourse</a>
              </li>
            </ul>
          </div>
          <div>
