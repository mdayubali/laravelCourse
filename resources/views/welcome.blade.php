<x-guest-layout>
    ...
    <div>
        ...
        <img src="{{ asset('img/right-center-angle.png') }}" alt="angle" class="w-auto h-auto object-contain absolute top-1/2 -translate-y-1/2 right-10 pointer-events-none">
       </div>
        ...
        <ul class="flex items-center flex-nowrap justify-between gap-y-7 gap-3">
            @foreach ($series as $item)
                <li class="w-full lg:max-w-[165px]">
                    <a href="#" class="bg-white border border-red-100 rounded-lg mx-auto flex items-center justify-center">
                    <img src="{{ $item['image'] }}" alt="{{ $item['name'] }}" class="w-20 md:w-auto h-auto box-shadow rounded-lg">
                    </a>
                </li>
            @endforeach
          </ul>
